                                                ...
                                                <div class="courses-filter">
                                                    <div class="clearfix">
                                                        <ul id="masonry" class="ttr-gallery-listing magnific-image row">
                                                            <li
                                                                ...
                                                                <div class="cours-bx">
                                                                    <div class="action-box">
                                                                        <img src="{{ asset('assets/images/courses/pic1.jpg') }}"
                                                                            alt="">
                                                            ...
                                                            <li
                                                                class="action-card col-xl-4 col-lg-6 col-md-12 col-sm-6 pending">
                                                                <div class="cours-bx">
                                                                    <div class="action-box">
                                                                        <img src="{{ asset('assets/images/courses/pic2.jpg') }}"
                                                                            alt="">
                                                                        <a href="#" class="btn">Read More</a>
                                                                    </div>
                                                                    <div class="info-bx text-center">
                                                                        <h5>
                                                                            ...
                                                                            <a href="#">Introduction EduChamp – LMS
                                                                                plugin</a>
                                                                        </h5>
                                                                        <span>Programming</span>
                                                                    </div>
                                                            ...
                                                            <li
                                                                ...
                                                                <div class="cours-bx">
                                                                    <div class="action-box">
                                                                        <img src="{{ asset('assets/images/courses/pic3.jpg') }}"
                                                                            alt="">
                                                                        <a href="#" class="btn">Read More</a>
                                                                    </div>
                                                                    <div class="info-bx text-center">
                                                            ...
                                                            <li
                                                                ...
                                                                <div class="cours-bx">
                                                                    <div class="action-box">
                                                                        <img src="{{ asset('assets/images/courses/pic4.jpg') }}"
                                                                            alt="">
                                                                        <a href="#" class="btn">Read More</a>
                                                                    </div>
                                                                    <div class="info-bx text-center">
                                                            ...
                                                            <li
                                                                ...
                                                                <div class="cours-bx">
                                                                    <div class="action-box">
                                                                        <img src="{{ asset('assets/images/courses/pic5.jpg') }}"
                                                                            alt="">
                                                                        <a href="#" class="btn">Read More</a>
                                                                    </div>
                                                                    <div class="info-bx text-center">
                                                            ...
                                                            <li
                                                                ...
                                                                <div class="cours-bx">
                                                                    <div class="action-box">
                                                                        <img src="{{ asset('images/courses/pic6.jpg') }}"
                                                                            alt="">
                                                                        <a href="#" class="btn">Read More</a>
                                                                    </div>
                                                                    <div class="info-bx text-center">
                                                            ...
                                                            <li
                                                                ...
                                                                <div class="cours-bx">
                                                                    <div class="action-box">
                                                                        <img src="{{ asset('assets/images/courses/pic7.jpg') }}"
                                                                            alt="">
                                                                        <a href="#" class="btn">Read More</a>
                                                                    </div>
                                                                    <div class="info-bx text-center">
                                                            ...
                                                            <li
                                                                ...
                                                                <div class="cours-bx">
                                                                    <div class="action-box">
                                                                        <img src="{{ asset('assets/images/courses/pic9.jpg') }}"
                                                                            alt="">
                                                                        <a href="#" class="btn">Read More</a>
                                                                    </div>
                                                                    <div class="info-bx text-center">
                                            ...
                                            <div class="tab-pane" id="edit-profile">
                                                ...
                                                <form action="/profile"  method="POST" class="edit-profile">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="form-group row">
                                                            <label
                                                                class="col-12 col-sm-3 col-md-3 col-lg-2 col-form-label">Email
                                                            </label>
                                                            <div class="col-12 col-sm-9 col-md-9 col-lg-7">
