		...
		<div class="ttr-header-wrapper">
			...
			<div class="ttr-header-right ttr-with-seperator">
				...
				<ul class="ttr-header-navigation">
					...
					<li>
						<a href="#" class="ttr-material-button ttr-submenu-toggle"><span class="ttr-user-avatar"><img alt="" src="https://mdbcdn.b-cdn.net/img/Photos/Avatars/img (31).webp" width="32" height="32"></span></a>
						<div class="ttr-header-submenu">
							<ul>
		...
		<div class="ttr-sidebar-wrapper content-scroll">
			...
			<nav class="ttr-sidebar-navi">
				<ul>
					...
					<li>
					<li>
						<a href="/admin/instructors" class="ttr-material-button">
