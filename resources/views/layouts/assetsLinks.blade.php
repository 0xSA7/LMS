                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink"
                                        ...
                                        <img src="https://mdbcdn.b-cdn.net/img/Photos/Avatars/img (31).webp"
                                            class="rounded-circle" height="10" style="width: 30px; height:30px ;"
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 text-center"> Developed by <a target="_blank"
                            href="https://taha-shaban-kaamel.github.io/portfolio/#home" class="text-warning"> Taha Shaban 👩‍💻</a></div>
                </div>
            </div>
        </div>
    </footer>
