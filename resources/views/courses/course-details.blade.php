              ...
              <div class="course-detail-bx">
                <div class="course-buy-now text-center">
                  ...
                  <form action="{{route('courseEnroll', $course->id)}}" method="POST">
                    @csrf
                    <button role="submit" class="btn radius-xl text-uppercase">Enrollment </button>
                  </form>
                  @endif
                </div>
                ...
                <div class="row">
                  <div class="col-md-12 col-lg-4">
                    <ul class="course-features">
                      ...
                      <li><i class="ti-help-alt"></i> <span class="label">Quizzes</span> <span class="value">1</span>
                      </li>
                      ...
                      <li><i class="ti-user"></i> <span class="label">Students</span> <span
                          class="value">{{$students_in_course}}</span></li>
